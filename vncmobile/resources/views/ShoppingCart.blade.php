                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="single-product.html"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="/nvs/{{$cart_item['thum']}}"></a>
                                            </td>

                                            <td class="product-name">
                                                <a href="single-product.html">{{$cart_item['name']}}</a>
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    ...
                                                    <input type="number" size="4" class="input-text qty text" title="Qty" value="{{$cart_item['quanty']}}" min="0" step="1">
                                            ...
                                            <td class="product-subtotal">
                                                <span class="amount">{{$cart_item['quanty']* $cart_item['price_sale']}}</span>
                                            </td>
                                        </tr>
