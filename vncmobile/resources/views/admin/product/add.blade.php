                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="price" name="price"  value="{{ old('price')}}" placeholder="Location">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputCity1">price_sale</label>
                        <input type="number" class="form-control" id="price_sale" name="price_sale"  value="{{ old('price_sale')}}" placeholder="Location">
                      </div>
                      <div class="form-group">
